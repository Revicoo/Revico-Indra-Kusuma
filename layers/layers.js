...
var format_BANGUNAN_PT_50K_2 = new ol.format.GeoJSON();
var features_BANGUNAN_PT_50K_2 = format_BANGUNAN_PT_50K_2.readFeatures(json_BANGUNAN_PT_50K_2, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_BANGUNAN_PT_50K_2 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_BANGUNAN_PT_50K_2.addFeatures(features_BANGUNAN_PT_50K_2);
var lyr_BANGUNAN_PT_50K_2 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_BANGUNAN_PT_50K_2, 
                style: style_BANGUNAN_PT_50K_2,
                interactive: true,
                title: '<img src="styles/legend/BANGUNAN_PT_50K_2.png" /> BANGUNAN_PT_50K'
            });

lyr_GoogleSatelit_0.setVisible(true);lyr_ADMINISTRASIKECAMATAN_AR_50K_1.setVisible(true);lyr_BANGUNAN_PT_50K_2.setVisible(true);
var layersList = [lyr_GoogleSatelit_0,lyr_ADMINISTRASIKECAMATAN_AR_50K_1,lyr_BANGUNAN_PT_50K_2];
...
lyr_BANGUNAN_PT_50K_2.set('fieldAliases', {'NAMOBJ': 'NAMOBJ', 'FCODE': 'FCODE', 'REMARK': 'REMARK', 'SRS_ID': 'SRS_ID', 'LCODE': 'LCODE', 'METADATA': 'METADATA', });
...
lyr_BANGUNAN_PT_50K_2.set('fieldImages', {'NAMOBJ': '', 'FCODE': '', 'REMARK': '', 'SRS_ID': '', 'LCODE': '', 'METADATA': '', });
...
lyr_BANGUNAN_PT_50K_2.set('fieldLabels', {'NAMOBJ': 'no label', 'FCODE': 'no label', 'REMARK': 'no label', 'SRS_ID': 'no label', 'LCODE': 'no label', 'METADATA': 'no label', });
lyr_BANGUNAN_PT_50K_2.on('precompose', function(evt) {
